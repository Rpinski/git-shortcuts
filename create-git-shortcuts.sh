...
config alias.f "fetch --tags --force"
config alias.ff "fetch --tags --force --all"
config alias.u "pull -r"
config alias.rmaster "!git fetch && git rebase origin/master"
config alias.rmain "!git fetch && git rebase origin/main"
config alias.p "push"
